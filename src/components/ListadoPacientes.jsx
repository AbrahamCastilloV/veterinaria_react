  ...
  return (
    <div className="md:w-1/2 lg:w-3/5 md:h-screen overflow-y-scroll">
      {pacientes && pacientes.length ? (
        ...
        <>
          <h2 className="font-black text-3xl text-center">No hay pacientess</h2>
          <p className="text-xl mt-5 mb-10 text-center">Comienza agregando pacientes<span className="text-indigo-600 font-bold"> y aparecerán en éste lugar</span></p>
        </>)}
