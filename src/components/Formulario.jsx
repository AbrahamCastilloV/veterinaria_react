...
function Formulario({pacientes, setPacientes, paciente, setPaciente}) {
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-5">
      ...
      <p className="text-center text-lg mt-5 mb-10">Añade Pacientes y <span className="text-indigo-600 font-bold ">Adminístralos</span></p>
      ...
      <form className="bg-white shadow-md rounded-lg py-10 px-5" onSubmit={handleSubmit}>
        ...
        <div className="mb-5">
          ...
          <input id="email" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md " type="email" placeholder="Email de Contacto del Propietario" value={email} onChange={e => setEmail(e.target.value)}/>
        </div>
        ...
        <input type="submit" className="bg-indigo-600 w-full text-white p-3 uppercase font-bold hover:bg-indigo-800 cursor-pointer transition-colors mb-10" value={paciente.id ? 'Editar Paciente' : 'Agregar Paciente'} />
